...
{
  PRINTF_ERROR ( "WARNING: out-of-memory allocating a block of size %u (%s:%u)\n",
           size, filename, line);
}
...
printf(  "alloc: %d, %s:%d\n", (int) da__allocation_size, __FILE__, __LINE__ ); \
